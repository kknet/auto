...
function kkddl(){
    ...
    while(1){
        ...
        if(id("com.yuncheapp.android.pearl:id/settings").exists() && id("com.yuncheapp.android.pearl:id/icon").exists() && text("微信登录").exists() || id("com.yuncheapp.android.pearl:id/settings").exists() && id("com.yuncheapp.android.pearl:id/icon").exists() && text("任务").exists()){
            ...
            if(tem == 1 && text("任务").exists() || id("com.yuncheapp.android.pearl:id/avatar").exists() && id("com.yuncheapp.android.pearl:id/invite_code").exists() || id("com.yuncheapp.android.pearl:id/name").exists() && text("我的金币").exists() ){
                TKB.xgsrizhi("登录成功")
                toastLog("登录成功")
                tem = 1
