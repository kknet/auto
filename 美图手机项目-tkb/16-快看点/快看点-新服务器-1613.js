...
function kkdyh(){
    ...
    while(1){
        ...
        if(id("com.yuncheapp.android.pearl:id/tt_video_ad_close").exists()){
            TKB.xgsrizhi("看完广告关闭")
            try {
                var ss = id("com.yuncheapp.android.pearl:id/tt_video_ad_close").findOnce().bounds();
                click(ss.centerX(), ss.centerY());
                sleep(2000)
                sleep(1000)
            } catch(error) {
        ...
        if(id("com.yuncheapp.android.pearl:id/iv_close").exists()){
            TKB.xgsrizhi("关闭提示")
            try {
                var ss = id("com.yuncheapp.android.pearl:id/iv_close").findOnce().bounds();
                // click(ss.centerX(), ss.centerY());
                sleep(2000)
                sleep(1000)
            } catch(error) {
        ...
        if(text("直播").exists() && id("com.yuncheapp.android.pearl:id/iv_app").exists() || id("com.yuncheapp.android.pearl:id/series_avatar").exists() && id("com.yuncheapp.android.pearl:id/comment_icon").exists() && id("com.yuncheapp.android.pearl:id/like_icon").exists() || id("com.yuncheapp.android.pearl:id/series_avatar").exists() && text("推荐").exists() && text("直播").exists() || id("com.yuncheapp.android.pearl:id/comment_icon").exists() && id("com.yuncheapp.android.pearl:id/like_icon").exists()  && text("推荐").exists()){
            ...
            if (dd == 0){
                TKB.xgsrizhi("去首页看新闻")
                if (id("com.yuncheapp.android.pearl:id/back").exists()){
                    TKB.xgsrizhi("看到返回按键")
                    back()
                    sleep(4000)
                    back()
    ...
    while(1){
        ...
        if(id("com.yuncheapp.android.pearl:id/settings").exists() && id("com.yuncheapp.android.pearl:id/icon").exists() && text("微信登录").exists() || id("com.yuncheapp.android.pearl:id/settings").exists() && id("com.yuncheapp.android.pearl:id/icon").exists() && text("任务").exists()){
            ...
            if(tem == 1 && id("com.yuncheapp.android.pearl:id/rl_button").exists() && text("首页").exists() || tem == 1 && text("任务").exists() || id("com.yuncheapp.android.pearl:id/avatar").exists() && id("com.yuncheapp.android.pearl:id/invite_code").exists() || id("com.yuncheapp.android.pearl:id/name").exists() && text("我的金币").exists() ){
                ...
                toastLog("登录成功")
                sleep(5000)
                if (dds < 2 && id("com.yuncheapp.android.pearl:id/my_gold").exists()){
                    try{
                        var ss = id("com.yuncheapp.android.pearl:id/my_gold").findOnce().text()
                        if (ss != "0" && ss != 0 && ss != ""){
                            TKB.upjine(sbip, yhname, yhbh, "kuaikandian", ss/10000)
                            log("我是金额" + ss)
                            dds = 10
                        }
                    }catch(error) {
...
function kkddl(){
    ...
    while(1){
        ...
        if ((new Date()).getTime() - TSD > 8*60*1000){
             TKB.xgsrizhi("超时没注册成功")
            back()
            sleep(1000)
            TKB.qinglihh()
        ...
        if(id("com.yuncheapp.android.pearl:id/settings").exists() && id("com.yuncheapp.android.pearl:id/icon").exists() && text("微信登录").exists() || id("com.yuncheapp.android.pearl:id/settings").exists() && id("com.yuncheapp.android.pearl:id/icon").exists() && text("任务").exists()){
            ...
            if(tem == 1 && id("com.yuncheapp.android.pearl:id/rl_button").exists() && text("首页").exists() || tem == 1 && text("任务").exists() || id("com.yuncheapp.android.pearl:id/avatar").exists() && id("com.yuncheapp.android.pearl:id/invite_code").exists() || id("com.yuncheapp.android.pearl:id/name").exists() && text("我的金币").exists() ){
                ...
                toastLog("登录成功")
                sleep(5000)
                if (id("com.yuncheapp.android.pearl:id/my_gold").exists()){
                    try{
                        // var ss = id("com.yuncheapp.android.pearl:id/my_gold").findOnce().text()
                        var ss = id("com.yuncheapp.android.pearl:id/my_gold").findOnce().bounds();
                        click(ss.centerX(), ss.centerY());
                        sleep(2000)
                    }catch(error) {
                        sleep(1001)
        ...
        if(text("收益记录").exists() && text("去提现").exists() || text("收益说明").exists() && text("去提现").exists()){
            TKB.xgsrizhi("去提现")
            click("去提现")
            sleep(2000)
        }
        if(text("我要提现").exists() && text("提现记录").exists() || text("收益说明").exists() && text("微信").exists()){
            TKB.xgsrizhi("提现")
            dds  =dds + 1
            click("微信")
            sleep(1500)
        ...
        if(text("提现").exists() && desc("预计48小时内到账").exists()){
            TKB.xgsrizhi("提取")
            click(500, 790)
            sleep(4000)
        }
        if(desc("提现申请已经提交给微信，请等待微信处理").exists() && desc("提现").exists()){
            TKB.xgsrizhi("提现成功")
            back()
            sleep(4000)
            return true
