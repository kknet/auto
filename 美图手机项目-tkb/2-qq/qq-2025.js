    ...
    while(1){
        ...
        if(text("用户注册").exists() && text("忘记密码").exists() ){
            ...
            if (bb == 1){
                ...
                sleep(1000)
                try{
                    if (id("com.tencent.mobileqq:id/xgsrizhiin").exists()){
                        xgsrizhi("点击控件")
                        var ss = id("com.tencent.mobileqq:id/xgsrizhiin").findOnce().bounds();
                        xgsrizhi(ss)
