...
// wdjxiazai('趣头条','v3.9.73.000.0415.1742')
//趣头条登录
function qttdenglu() {
    log('趣头条登录')
    ...
    while (1) {
        ...
        if (text('个人隐私保护指引').exists() && text('仅浏览').exists() && text('我知道了').exists()) {
            log('个人隐私保护指引')
            click('我知道了')
            sleep(2000)
        }
        if (id('com.jifen.qukan:id/af5').exists() && text('先去逛逛').exists()) {
            log('点击红包')
            click(random(500, 600), random(1040, 1210))
            sleep(5000)
        }
        if (text('微信登录').exists() && id('com.jifen.qukan:id/bwn').exists() || text('微信一键登录').exists() && id('com.jifen.qukan:id/bwo').exists()) {
            log('微信登录')
            click('微信一键登录')
            sleep(2000)
        }
        ...
        if (text('恭喜您获得一个新人红包！').exists() && id('com.jifen.qukan:id/afg').exists() || text('点击领钱').exists() && id('com.jifen.qukan:id/afl').exists()) {
            log('登录成功点击红包')
            click('点击领钱')
            sleep(2000)
        }
        if (text('任务中心').exists() && id('com.jifen.qukan:id/afg').exists()) {
            log('任务中心')
            back()
            sleep(2000)
        }
        if (text('刷新').exists() && text('视频').exists() && text('任务').exists() && text('我的').exists()||text('刷新').exists() && text('视频').exists() && text('赚钱').exists() && text('我的').exists()) {
            log('点击我的进入授权登录')
            click('我的')
            sleep(2000)
            if (text('邀请好友').exists() && text('面对面红包').exists() && text('赚分红').exists()) {
                log('登录成功进入我的页面')
                return true
            }else if (text('微信登录').exists() && id('com.jifen.qukan:id/bwn').exists() || text('微信一键登录').exists() && id('com.jifen.qukan:id/bwo').exists()) {
                continue
            }
        }
    }
...
function qttyh() {
    ...
    while (1) {
        ...
        try {
            if (text('头条').exists() && text('刷新').exists() && text('小视频').exists() && text('我的').exists()) {
                click('头条')
            }
