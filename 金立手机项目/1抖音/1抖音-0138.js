...
function zonghe() {
    ...
    if (text("授权提示").exists()) {
        TKB.xgsrizhi("点击关闭")
        id("com.ss.android.ugc.aweme:id/bn0").findOnce().click()
        sleep(2000)
    }
...
function searchItem() {
    ...
    var ifClick = true;
    var item = 0
    var keyword, keywords, word, counts, likeMin, likePercent
    var sum = 0
    var xs = TKB.zhid(sbip, run_id)
    keywords = xs['关键词'];
    counts = xs['关注人数'];
    ...
    while (true) {
        try {
            ...
            if (ifClick == true) {
                ...
                if (text("综合").exists() && text("用户").exists() && text(keyword).exists()) {
                    click("用户")
                    TKB.xgsrizhi("点击用户")
                    sleep(5000)
                    while (1) {
                        if (id("com.ss.android.ugc.aweme:id/a2y").exists()) {
                            var follows = id("com.ss.android.ugc.aweme:id/a2y").find().filter((w) => {
                                return w.bounds().top < w.bounds().bottom
                            })
                        }
                        if (id("com.ss.android.ugc.aweme:id/yg").exists()) {
                            var follows = id("com.ss.android.ugc.aweme:id/yg").find().filter((w) => {
                                return w.bounds().top < w.bounds().bottom
                            })
                        }
                        sleep(2000)
                        ...
                        TKB.xgsrizhi("点击关注")
                        sleep(2000)
                        swipe(random(500, 700), 1300, random(500, 700), 500, 1500);
                        TKB.xgsrizhi("滑动")
                        sleep(3000)
                        sum++
                        log(sum)
            ...
            if (text("关注").exists() && text("消息").exists() && text("我").exists()) {
                (text("推荐").exists() && text("关注").exists() && item == 0) ? (click("关注"), item = 1, log("点击关注")) : ''
                sleep(5000)
                if (id("com.ss.android.ugc.aweme:id/awb").exists()) {
                    if (text("点击进入直播间").exists()) {
                        swipe(random(400, 600), 1600, random(400, 600), 300, 1500)
                        TKB.xgsrizhi("直播间，跳过")
                        sleep(3000)
                    }
                    var totalLikes = id("com.ss.android.ugc.aweme:id/awb").find().filter(function(w) {
                        return w.bounds().top < w.bounds().bottom
                    })[0].text();
                ...
                if (random(1, 100) < likePercent) {
                    if (id("com.ss.android.ugc.aweme:id/awa").exists()) {
                        id("com.ss.android.ugc.aweme:id/awa").findOnce().click();
                        sleep(2000)
                        TKB.xgsrizhi("点赞")
                    }
                }
