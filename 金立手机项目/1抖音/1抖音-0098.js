...
function gaizl() {
    ...
    while (1) {
        ...
        if (text("名字").exists() && text("抖音号").exists() || text("编辑资料").exists() && text("抖音号").exists() || text("编辑个人资料").exists() && text("名字").exists()) {
            ...
            if (tep == 2) {
                if ((text("男").exists() || text("女").exists() && text("性别").exists())) {
                    toastLog("性别修改完成")
                    tep = 3
                } else {
                    click('性别')
            ...
            if (tep == 3) {
                ...
                if (name_result == true) {
                    var name_return = '抖音昵称符合'
                } else {
                    var name_return = '抖音昵称不符合'
                }
                if (img_result == true) {
                    var img_return = '抖音头像符合'
                } else {
    ...
    while (1) {
        ...
        if (id("com.ss.android.ugc.aweme:id/fza").exists()) {
            if (redPacketm == 0) {
                ...
                var waitTime = Number(redPacket[0]) * 60 + Number(redPacket[1]);
            }
            redPacketm = 1
        }
        log(waitTime);
...
function follow() {
    ...
    while (1) {
        ...
        try {
            ...
            if ((text('抖音号:' + live_obj).exists() && (text('已关注').exists() || text('互相关注').exists())) || (descEndsWith('的头像').exists() && (text('取消关注').exists() || text('互相关注').exists()))) {
...
function playamount() {
    ...
    while (1) {
        try {
            ...
            if (id("com.ss.android.ugc.aweme:id/g8z").exists()) {
                var playamount = id("com.ss.android.ugc.aweme:id/g8z").findOnce()
                var playamounts = id("com.ss.android.ugc.aweme:id/g8z").findOnce().text()
            }
            if (playamounts < 100) {
                click(playamount.bounds().centerX(), playamount.bounds().centerY())
                sleep(3000)
