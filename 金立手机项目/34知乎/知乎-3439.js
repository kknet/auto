...
function zhdl() {
    ...
    try {
        if (fun == "养号") {
            ...
            TKB.xgsrizhi("获取到的话术" + comment_sentence)
        }
    } catch (error) {
        TKB.xgsrizhi(error);
    }
        ...
        try {
            ...
            if (a == 2) {
                ...
                if (text('性别').exists() && text('用户名').exists()) {
                    if (id('com.zhihu.android:id/value').findOnce().text() == xb) {
                        TKB.xgsrizhi('性别选择完成')
                        a = 3
                        sleep(2000)
            ...
            if (a == 6) {
                ...
                if (name_result == true) {
                    var name_return = '知乎昵称符合'
                } else {
                    var name_return = '知乎昵称不符合'
                }
                if (img_result == true) {
                    var img_return = '知乎头像符合'
                } else {
                    var img_return = '知乎头像不符合'
                }
                toastLog(name_return + ',' + img_return)
    ...
    while (1) {
        try {
            ...
            if (comment_url != undefined) {
                ...
                //进入到了作品链接
                if (id("com.zhihu.android:id/search_btn").exists()) {
        ...
        try {
            ...
            if (likeclick_url != undefined) {
                ...
                if (id("com.zhihu.android:id/search_btn").exists()) {
                    ...
                    //     sleep(3000)
                    // }
                    if (descStartsWith(' 赞同 ').exists()) {
                        TKB.xgsrizhi("点击赞同")
                        descStartsWith(' 赞同 ').findOnce.click()
                        sleep(5000)
                        TKB.qinglihh(dqbaoming)
                        return true
                    }
