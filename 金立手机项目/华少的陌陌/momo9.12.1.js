...
var baseurl='http://119.23.250.50/ling'//主api
var api = {
	momo:'821283872',//陌陌主号
	pwd:'milu8888',//默认密码
    ...
    beifen:'http://119.23.250.50/wenzhou/setBeifen.php',
...
function shoujihaozhuce() {
    ...
    while (1) {
        try {
            ...
            if (findeclick("text", "搜索用户：413711749", 5000)) {
                toastLog("注册流程完成")
                back()
                sleep(500)
                back()
                sleep(2000)
                if (text('搜索用户：413711749').exists()) {
                    back()
                    sleep(2000)
                }
                return true
