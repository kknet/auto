            ...
            if (kee == 1) {
                ...
                if (text("修改").exists() && text("返回").exists()) {
                 ...
                 if((findeclick("text", "帐号密码登录", 800) || findeclick("text", "账号密码登录", 800) )&& up == 1){
                        if (text("帐号登录").exists() && text("手机号验证登录").exists()) {
...
function shoujihaozhuce() {
    ...
    while (1) {
        try {
            ...
            //直播间返回
            id('com.immomo.momo:id/popup_phone_live_gesture_guide_iv_gesture').exists() ? back() : ''
            id('com.immomo.momo:id/mk_dialog_close_button').exists() ? back() : ''
            id('com.immomo.momo:id/rightSvgaView').exists() ? back() : ''
            id('com.immomo.momo:id/hani_pal_mask').exists() || id('com.immomo.momo:id/phone_live_layout_bottom').exists() ? back() : ''
            ...
            findeclick("text", "开启定位", 1200)
            findeclick("text", "权限", 800)
