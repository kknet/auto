 ...
 * 
 * @name {number} name 
 * @username {string} : 1:高清组，0:普通
 * @appname {string} resource_type 1:高清组，0:普通
 * @username {string} resource_type 1:高清组，0:普通
 * @param {string} resource_type 1:高清组，0:普通
 */
function get_name(name, appname, username, appname) {
    log("上传应用账号信息")
