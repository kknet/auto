 ...
 * @param {Number} get_type:获取方式 默认1 这批素材只是用1次 ，否则重复使用
 */
function get_videoList(name, imp_id, store_name, get_type) {
    log('获取视频')
...
function fabusp() {
    ...
    var store_name = xs['资料库的标签名称']
    var imp_id = action_args['imp_id']
    var get_type_num = xs['是否重复使用']
    var biaoti = xs['标题']
    // var store_name = '人物1'
    // var imp_id = '892'
    // var get_type_num = '是'
    ...
    var zz = get_videoList(name, imp_id, store_name, get_type)
    log(zz)
